                    ...
                    while True:
                        try:
                            if SINGLE_FILE_TRANSFER_ROOMS[TRANSFER_ACCESS_TOKEN].get('client_ready'):
                                ...
                                await ws.send_json({'begin_upload':True, 'file_id':FILE_ID_ASSIGNED_BY_USER, 'client_username':  SINGLE_FILE_TRANSFER_ROOMS['client_username']}) if not HOST_NOTIFIED else None
                                HOST_NOTIFIED = True
